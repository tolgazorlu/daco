...
const Terms = () => {
    return (
        <>
            <Layout />
            <div className="py-10 px-4 lg:px-24 gap-4 mt-20 md:p-10 prose-base font-poppins">
                <h2>
                    <strong>Terms and Conditions</strong>
                </h2>

                <p>Welcome to Dacospace!</p>

                <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Dacospace's Website, located at
                    https://daco.space.
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Dacospace if you do
                ...
                <p>
                    ...
                    with and subject to, prevailing law of tr. Any use of the
                ...
                <p>
                    We employ the use of cookies. By accessing Dacospace, you
                    agreed to use cookies in agreement with the Dacospace's
                    Privacy Policy.
                </p>
                ...
                <p>
                    Unless otherwise stated, Dacospace and/or its licensors own
                    the intellectual property rights for all material on
                    Dacospace. All intellectual property rights are reserved.
                    You may access this from Dacospace for your own personal use
                    subjected to restrictions set in these terms and conditions.
                </p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Dacospace</li>
                    <li>Sell, rent or sub-license material from Dacospace</li>
                    <li>
                        Reproduce, duplicate or copy material from Dacospace
                    </li>
                    <li>Redistribute content from Dacospace</li>
                </ul>
                ...
                <p>
                    Dacospace reserves the right to monitor all Comments and to
                ...
                <p>
                    You hereby grant Dacospace a non-exclusive license to use,
                ...
                <p>
                    ...
                    compensates the absence of Dacospace; and (d) the link is in
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Dacospace. Please include
                ...
                <p>
                    No use of Dacospace's logo or other artwork will be allowed
