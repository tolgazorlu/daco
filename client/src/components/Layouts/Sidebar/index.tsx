        ...
        <aside
            ...
            className={
                !isCurrentDashboard
                    ? "hidden"
                    : props.isOpen
                      ? "overflow-scroll fixed top-0 left-0 lg:left-24 z-20 w-64 h-screen pt-20 transition-transform -translate-x-0  sm:translate-x-0 bg-base-100"
                      : "overflow-scroll fixed top-0 left-0 lg:left-24 z-20 w-64 h-screen pt-20 transition-transform -translate-x-full  sm:translate-x-0 bg-base-100"
            }
            aria-label="Sidebar"
        >
            <div className="h-full px-3 py-4">
                ...
                >
                    ...
                    <p className="mb-3 text-sm text-primary-content">
                        Preview the new As{" "}
                        <span className="font-bold font-aubette">DACO</span>, we
                        are here with the beta version. If you would like to
                        support the project, you can access the source codes
                        from the{" "}
                        <a
                            href="https://github.com/tolgazorlu/daco"
                            target="_blank"
