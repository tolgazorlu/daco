    ...
    return (
        <section className="lg:grid grid-cols-2 px-4 lg:px-24">
            <div className="h-screen md:snap-start flex flex-col justify-center">
                ...
                <h1 className="font-title text-center font-bandal text-[clamp(2rem,6vw,4.2rem)] font-black leading-[1.1] [word-break:auto-phrase] xl:w-[115%] xl:text-start [:root[dir=rtl]_&amp;]:leading-[1.35]">
