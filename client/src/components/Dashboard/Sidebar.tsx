const Sidebar = () => {
  return (
    <>
      <aside
        id="default-sidebar"
        className="border-r-2 col-span-3 bg-base-100"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4">
          <ul className="space-y-2 font-medium">
            <li>
              <a
                href="/dashboard"
                className="flex items-center p-2 rounded-lg bg-primary text-primary-content"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Problems</span>
              </a>
            </li>
          </ul>
