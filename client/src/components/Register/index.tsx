                ...
                <div className="h-screen md:snap-start flex flex-col justify-center lg:items-center px-4">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                                type="button"
                                className="btn w-full text-white  bg-neutral hover:bg-neutral/80 focus:ring-4 focus:outline-none focus:ring-[#4B5563]/50 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center  justify-center lg:justify-between"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="20"
