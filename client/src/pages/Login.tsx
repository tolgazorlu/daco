      ...
      <FullScreen handle={handle}>
        ...
        <div className="flex h-[90vh] py-8">
          {/* <div className="h-[90vh] w-1/2 flex justify-end">
            <img
              className="h-[80vh] rounded-2xl border-4 border-primary"
              src={HeroImage}
            /> 
            <div className="h-[80vh] w-5/6 flex justify-center items-center font-aubette text-9xl gap-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth={2.5}
                className="w-32 h-32 stroke-secondary"
              >
                <path
                  strokeLinecap="round"
              ...
              <span className="text-primary">DACO</span>
            </div>
          </div> */}
